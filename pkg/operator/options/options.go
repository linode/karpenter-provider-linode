...
func (o *Options) AddFlags(fs *coreoptions.FlagSet) {
	...
	fs.IntVar(&o.ClusterID, "cluster-id", env.WithDefaultInt("LKE_CLUSTER_ID", 0), "The LKE cluster ID for LKE node pool operations. Required when using ManagedLKE options.")
